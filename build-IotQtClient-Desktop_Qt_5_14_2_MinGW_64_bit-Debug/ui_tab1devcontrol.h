...
public:
    ...
    void setupUi(QWidget *Tab1DevControl)
    {
        ...
        Tab1DevControl->resize(400, 300);
        verticalLayout_4 = new QVBoxLayout(Tab1DevControl);
        ...
        pLcdNumberLed->setSegmentStyle(QLCDNumber::Flat);
        ...
        pLcdNumberKey->setLineWidth(1);
        pLcdNumberKey->setSmallDecimalPoint(false);
        pLcdNumberKey->setDigitCount(2);
        pLcdNumberKey->setMode(QLCDNumber::Hex);
        pLcdNumberKey->setSegmentStyle(QLCDNumber::Flat);

        verticalLayout_2->addWidget(pLcdNumberKey);
